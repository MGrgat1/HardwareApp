package hr.tvz.grgat.hardwareapp.security.controller;

import hr.tvz.grgat.hardwareapp.security.command.LoginCommand;
import hr.tvz.grgat.hardwareapp.security.dto.LoginDTO;
import hr.tvz.grgat.hardwareapp.security.service.AuthenticationService;
...
public class AuthenticationController {
    ...
    public LoginDTO login(@Valid @RequestBody final LoginCommand command) {
        System.out.println("[AuthenticationController] RequestBody:" + command.toString());

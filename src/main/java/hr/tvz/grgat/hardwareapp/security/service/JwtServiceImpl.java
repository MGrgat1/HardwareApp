...
import hr.tvz.grgat.hardwareapp.security.domain.Authority;
import hr.tvz.grgat.hardwareapp.security.domain.User;
import hr.tvz.grgat.hardwareapp.security.user.ApplicationUser;
import hr.tvz.grgat.hardwareapp.security.user.UserAuthentication;
